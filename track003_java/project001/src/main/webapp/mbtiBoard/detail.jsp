   ...
   <div class="container card  my-5">
      <h3  class="card-header"> MBTI 글상세보기 </h3>
		<form action="detail.do" method="post">
			...
			<div class="mb-3">
				<a href="${pageContext.request.contextPath}/editView.do?id=${dto.id}" class="btn btn-dark form-control">글수정</a>
			</div>
			<div class="mb-3">
			...
			<div class="mb-3">
				<a href="${pageContext.request.contextPath}/list.do" class="btn btn-dark form-control">목록보기</a>
			</div>
